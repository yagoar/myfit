# Seamly catalog coverage

Auto-generated by `scripts/dump_recipe_table.py`. Values are the latest Yaiza extraction (`data/results/yaiza_seamly_catalog.json`).
...
| H08 | highbust_to_waist_f | Formula('H07 - H01') | extracted | -17.33 |
| H09 | neck_front_to_bust_f | SurfacePlumb | extracted | 18.64 |
| H10 | bust_to_waist_f | Formula('H09 - H01') | extracted | -13.24 |
...
| H15 | neck_side_to_highbust_f | SurfacePlumb | extracted | 20.64 |
...
| H22 | highbust_to_waist_b | Formula('H21 - H19') | extracted | -17.97 |
| H23 | neck_back_to_bust_b | SurfacePlumb | extracted | 18.51 |
| H24 | bust_to_waist_b | Formula('H23 - H19') | extracted | -15.23 |
